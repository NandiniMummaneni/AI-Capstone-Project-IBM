🌍 Geospatial Land Classification Using CNNs and Vision Transformers

Part of IBM AI Engineering Professional Certificate — Capstone Project.

This project demonstrates the development of deep learning models for classifying satellite imagery into different land types, such as crops, forests, and water bodies. It covers key AI engineering concepts including data preprocessing, model development, transfer learning, and performance evaluation.
...
How to preprocess and augment geospatial image datasets for deep learning.

The design, training, and evaluation of CNN and Vision Transformer models.

The application of transfer learning to improve model performance.

Visualization of model performance metrics to communicate outcomes effectively.

A structured and reproducible workflow for AI engineering projects.